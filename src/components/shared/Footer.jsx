      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 md:py-10">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-8 mb-8 text-center sm:text-left">
          ...
          <div className="flex flex-col items-center sm:items-start justify-center">
            <span className="font-extrabold text-4xl sm:text-5xl leading-normal py-2 bg-gradient-to-r from-green-400 via-teal-500 to-blue-500 bg-clip-text text-transparent select-none">
              Tiles Gallery
            </span>
          ...
          <div className="flex flex-col items-center sm:items-start">
            <h6 className="footer-title text-gray-800 dark:text-white font-bold opacity-100 mb-3 md:mb-4">Quick Links</h6>
            <div className="flex flex-col gap-2">
              <a href="/" className="link link-hover hover:text-success transition-colors">Home</a>
              <a href="/all-tiles" className="link link-hover hover:text-success transition-colors">All Tiles</a>
              <a href="/my-profile" className="link link-hover hover:text-success transition-colors">My Profile</a>
            </div>
          </div>

          <div className="flex flex-col items-center sm:items-start sm:col-span-2 md:col-span-1">
            <h6 className="footer-title text-gray-800 dark:text-white font-bold opacity-100 mb-3 md:mb-4">Contact Us</h6>
        ...
        <div className="border-t border-gray-400/20 pt-6 flex flex-col md:flex-row justify-between items-center gap-6 text-center md:text-left text-sm text-gray-500">
          <p className="order-2 md:order-1">© {new Date().getFullYear()} Tiles Gallery. All rights reserved.</p>
